...
namespace Ranger.InternalHttpClient {
    public class ApiClientBase : IApiClient {
        ...
        protected Exception GenericErrorException<TResponseObject> (InternalApiResponse<TResponseObject> apiResponse) {
            return new Exception (String.Join (Environment.NewLine, apiResponse.Errors ?? new string[] { "An exception occured with the request. No error information is available." }));
        }
    }
}